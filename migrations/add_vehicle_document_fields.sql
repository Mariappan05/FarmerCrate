...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        ELSE
            -- If neither exists, add doc_id as primary key
            ALTER TABLE permanent_vehicle_documents ADD COLUMN doc_id SERIAL PRIMARY KEY;
        END IF;
    END IF;
END $$;

-- Add all document fields to permanent_vehicle_documents table
